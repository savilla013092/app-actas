...
const LOCATION_CATALOG: Record<string, string> = {
  '0': 'Redes',
...
export function normalizeClassificationCode(value?: string | number | null): string | undefined {
...
export function resolveClassificationName(
...
export function resolveLocationName(value?: string | number | null): string {
  if (value === undefined || value === null) {
